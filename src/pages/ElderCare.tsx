...
const ElderCare = () => {
  ...
  const impactStats = [
    { icon: Users, number: "31", label: "Elderly Women Supported", color: "text-blue" },
    { icon: Calendar, number: "10+", label: "Years of Service", color: "text-primary" },
    { icon: Heart, number: "100%", label: "Dignity Restored", color: "text-destructive" },
    { icon: Star, number: "∞", label: "Smiles Created", color: "text-gold" },
  ];
          ...
          >
            ...
            >
              <motion.button
                ...
                whileTap={{ scale: 0.95 }}
                className="group bg-gradient-to-r from-primary to-primary-light text-white px-8 py-4 rounded-full font-bold text-lg shadow-2xl transition-all duration-300 inline-flex items-center gap-3 border-2 border-white/30"
              >
                Support Elder Care
                <motion.div
                  animate={{ x: [0, 5, 0] }}
              ...
              >
                ...
                <div className="relative bg-gradient-to-br from-white to-background p-12 md:p-16 rounded-3xl shadow-2xl border border-primary/10">
                  <p className="text-2xl text-gray-700 leading-relaxed mb-8">
                    The slums of <span className="font-bold text-primary">Bengaluru</span> are home to many elderly people — in some communities over{" "}
                    <span className="font-bold text-primary-light">6% are aged 60 or above</span>.
                  </p>
                  <p className="text-2xl text-gray-700 leading-relaxed mb-8">
          ...
          <div className="max-w-7xl mx-auto">
            ...
            >
              <motion.div
                ...
                viewport={{ once: true }}
                transition={{ duration: 0.6 }}
                className="inline-block bg-gradient-to-r from-primary to-primary-light text-white px-6 py-2 rounded-full text-sm font-semibold mb-8"
                >
                  COMPREHENSIVE CARE
                </motion.div>
                
                <h2 className="text-6xl md:text-7xl font-heading font-black bg-gradient-to-r from-primary to-primary-light bg-clip-text text-transparent mb-6">
                What We Provide
              </h2>
